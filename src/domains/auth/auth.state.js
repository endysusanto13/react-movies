...
const register = (username, email, password, avatarUrl) =>
...
export const useRegister = () => {
  return function invokeRegister({ username, email, avatarUrl, password }) {
    return register(username, email, password, avatarUrl);
  };
};

export const getUserDetails = ({ accessToken, signal }) => {
